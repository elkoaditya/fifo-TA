    ...
    <div class="row">
                ...
                <table class="user-list-table table" id="workerskills">
                    ...
                    @foreach($prices as $price)
                        <tr>
                            ...
                            <td class="text-info">{{ $price->name }}</td>
                            <td>{{ $price->price }}</td>
        ...
        <div class="col-4">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form form-horizontal" method="post" action="/superadmin/price/store">@csrf
                        <div class="row">
                            <div class="col-12">
                                <div class="mb-1 row">
                                    <div class="col-sm-3">
                                ...
                                <div class="mb-1 row">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input type="number" id="file-text" class="form-control" name="price" />
                                        </div>
                                    </div>
                                </div>
                            </div>
