    ...
    <div class="row">
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu">
                                        <a type="button" class="dropdown-item text-danger" onclick="deleteSkill('{{$user->id}}')">Delete User</a>
                                    </div>
                                </div>
                            </td>
        ...
        <div class="col-4">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form form-horizontal" method="post" action="/superadmin/management-users/store">@csrf
                        <div class="row">
                            <div class="col-12">
                                <div class="mb-1 row">
                                    <div class="col-sm-3">
                                ...
                                <div class="mb-1 row">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input type="text" id="file-text" class="form-control" name="username" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="mb-1 row">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input type="password" id="contact-icon" class="form-control" name="password" />
                                        </div>
                                    </div>
                                </div>
                            </div>
